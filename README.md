...
There may be a total of 256 entries, one for each interrupt number. An entry is not needed for every interrupt even if it is implemented.
...
| Number | Name | DPL | Notes |
| ----- | ---- | --- | --- |
| 0 | Divide Error | 0 | Generated by CPU. |
| 6 | Invalid Opcode | 0 | Generated by CPU. |
| 8 | Double Fault | 0 | Generated by CPU. |
| 13 | General Protection Fault | 0 | Generated by CPU. |
| 14 | Page Fault | 0 | Generated by CPU. |
| 32 | Timer | 0 | For preemptive scheduling. |
| 33 | Keyboard | 0 | IRQ1. |
| 0x80 | System Call | 3 | |
